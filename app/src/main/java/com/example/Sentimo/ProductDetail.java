...
//    public Reviews[] review=new Reviews[3];
    ...
    public void resetActivity(){
        int id = getResources().getIdentifier(movieName, "drawable", "com.example.Sentimo");
...
//        int positive=getResources().getIdentifier("pos","drawable","com.example.Sentimo");
//        int negative=getResources().getIdentifier("neg","drawable","com.example.Sentimo");
...
//                int imageId=getResources().getIdentifier(movieName,"drawable","com.example.Sentimo");
